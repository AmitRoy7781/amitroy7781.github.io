...
Besides, I contributed to generative AI projects at <a href="https://www.amazon.science/author/amit-roy">Amazon</a> with the Prime Video and Personalization Discovery Team for personalized reranking of retrieved videos from user queries using reinforcement learning, and the Finance Technology team for accurate information retrieval from multiple structured documents e.g., multiple spreadsheets, through natural language instructions using RAG for metadata retrieval and code-based LLM Agents. In addition, I have experience in developing deep learning architectures for real-life applications involving LLMs and Graph Machine Learning. <br><br> 
...
<ul>
  ...
  <li>
    ...
    <img src="https://img.shields.io/github/stars/amitroy7781/transformers_graph_connectivity?style=social" alt="">
    </p>
  </li>
  </div>
  </div>
...
<ul>
  ...
  <li>
    ...
    Instructors: Prof. Tianyi Zhang and Prof. Steve Hanneke
  </li>
  ...
  <li>
    ...
    Instructors: Prof. Steve Hanneke and Prof. Ruqi Zhang 
