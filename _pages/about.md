...
In recent times, I have been interested in LLM reasoning-based concepts via post-training, e.g., scaling test-time compute, preference optimization algorithms e.g. DPO/PPO/GRPO, knowledge distillation, the mixture of experts,  RAG, chain-of-thought, etc., and how we can improve them for different applications involving graph reasoning, information retrieval and knowledge editing. I am experienced in developing deep learning architectures, e.g., LLMs and GNNs, that approach real-life problems. I worked with  Prof. <a href="https://scholar.google.com/citations?user=IroP0EwAAAAJ"> Pan Li</a>  for a while on the Graph Anomaly Detection problem, funded by Sony, Belgium. <br><br>
